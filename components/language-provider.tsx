...
const translations = {
  en: {
    ...
    'footer.services.injection': 'Injection',
  ...
  tr: {
    ...
    'footer.services.injection': 'Enjeksiyon',
    ...
    'footer.services.bpSugarMonitoring': 'Tansiyon & Şeker Takibi',
    'footer.services.woundCare': 'Yara Bakımı',
    'footer.services.catheterCare': 'Sonda Takma & Çıkarma',
    'footer.services.medicalAesthetics': 'Medikal Estetik',
    'footer.services.ozoneTherapy': 'Ozon Tedavisi',
    'footer.services.prpTherapy': 'PRP Uygulamaları',
